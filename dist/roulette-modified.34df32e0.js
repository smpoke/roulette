...
},{"./localization":"7e5dA","./options":"jebMA","./registerServiceWorker":"dWLxR","./roulette":"dWQgg","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7e5dA":[function(require,module,exports,__globalThis) {
...
const Translations = {
    en: {
        ...
        'Export result to Excel': 'Export result to Excel'
    },
    ko: {
        ...
        '2025 Recap': "2025 \uACB0\uC0B0",
        'Export result to Excel': "\uACB0\uACFC \uC5D1\uC140\uB85C \uB0B4\uBCF4\uB0B4\uAE30"
    }
};
...
class Roulette extends EventTarget {
    ...
    async _init() {
        ...
        this._rankRenderer = new (0, _rankRenderer.RankRenderer)();
    ...
    getResultRows() {
        return this._rankRenderer.getResultRows();
    }
    getMaps() {
...
class Marble {
    ...
    _drawName(ctx, zoom) {
        (0, _transformGuard.transformGuard)(ctx, ()=>{
            ctx.font = `bold 12pt 'Jua', sans-serif`;
...
},{"./data/constants":"dKlb7","./options":"jebMA","./utils/transformGuard":"9MbaE","./utils/Vector":"3pOEC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9MbaE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils/utils":"ljVDB","./utils/Vector":"3pOEC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ljVDB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"Agzxl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RankRenderer {
    ...
    render(ctx, { winners, marbles, winnerRank, theme }, width, height) {
        ...
        ctx.save();
        ctx.textAlign = 'right';
        ctx.font = "bold 10pt 'Jua', sans-serif";
        ctx.fillStyle = '#666';
        ...
        ctx.font = "bold 11pt 'Jua', sans-serif";
        if (theme.rankStroke) {
            ctx.lineWidth = 2;
...
class RouletteRenderer {
    ...
    async _load() {
        ...
        const marbleSkinUrls = [
            new URL(require("448090ca3be9c551")),
            new URL(require("1296178c4a507dac")),
            new URL(require("83176c10bc0c2c15")),
            new URL(require("317daa81bd01ed41")),
            new URL(require("fc73e73f461bdb28")),
            new URL(require("471578c97c0298fc")),
            new URL(require("751e99df733c07cc")),
            new URL(require("92f7cbc43483eb7"))
        ];
        this._marbleSkins = new Array(marbleSkinUrls.length);
        loadPromises.push(...marbleSkinUrls.map((imgUrl, index)=>{
            return (async ()=>{
    ...
    getMarbleImage(name, id) {
        ...
        if (this._marbleSkins.length > 0) return this._marbleSkins[this._hashIdToIndex(id, this._marbleSkins.length)];
        return undefined;
    }
    onBeforeEntities() {}
    onAfterScene() {}
    ...
    renderMarbles({ marbles, camera, winnerRank, winners, size }) {
        ...
        marbles.forEach((marble, i)=>{
            marble.render(this.ctx, camera.zoom * (0, _constants.initialZoom), i === winnerIndex, false, this.getMarbleImage(marble.name, marble.id), viewPort, this._theme);
        });
    }
    renderWinner({ winner, theme }) {
        ...
        const marbleCenterY = this._canvas.height - 84;
        ...
        if (theme.winnerOutline) this.ctx.strokeText('Winner', textRightX, this._canvas.height - 120);
        this.ctx.fillText('Winner', textRightX, this._canvas.height - 120);
        this.ctx.font = "bold 72px 'Jua', sans-serif";
        this.ctx.fillStyle = `hsl(${winner.hue} 100% ${theme.marbleLightness})`;
        if (theme.winnerOutline) this.ctx.strokeText(winner.name, textRightX, this._canvas.height - 55);
        this.ctx.fillText(winner.name, textRightX, this._canvas.height - 55);
        this.ctx.restore();
    }
}

},{"./data/constants":"dKlb7","./keywordService":"6oWe2","3c1155060c04461c":"4QZHP","448090ca3be9c551":"3ENqc","1296178c4a507dac":"iUeek","83176c10bc0c2c15":"1aq6e","317daa81bd01ed41":"4k0Jk","fc73e73f461bdb28":"gcEls","471578c97c0298fc":"4Efwi","751e99df733c07cc":"iIDur","92f7cbc43483eb7":"j2ytu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6oWe2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3ENqc":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu1.47b33df4.webp") + "?" + Date.now();

},{}],"iUeek":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu2.4deb6001.webp") + "?" + Date.now();

},{}],"1aq6e":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu3.aab46f5d.webp") + "?" + Date.now();

},{}],"4k0Jk":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu4.5f617127.webp") + "?" + Date.now();

},{}],"gcEls":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu5.8d492b2d.webp") + "?" + Date.now();

},{}],"4Efwi":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu6.c85b733a.webp") + "?" + Date.now();

},{}],"iIDur":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu7.2b112f9a.webp") + "?" + Date.now();

},{}],"j2ytu":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("wolfu8.b5f940a7.webp") + "?" + Date.now();
...
},{"./utils":"ljVDB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9ZvZc","gH3Lb"], "gH3Lb", "parcelRequire5cc2", {}, "./", "/")

//# sourceMappingURL=roulette-modified.34df32e0.js.map
